    ...
    <main className="min-h-screen bg-[#040607] py-8 sm:py-12 md:py-16 text-[#f3eadf]">
      <div className="mx-auto max-w-[1500px] px-4 sm:px-6 lg:px-8">
        ...
        <div className="max-w-3xl space-y-4 mb-10">
          <div className="h-4 w-24 bg-[#2a231c] rounded-lg animate-pulse"></div>
          <div className="h-12 w-48 bg-[#2a231c] rounded-lg animate-pulse"></div>
          <div className="h-6 w-full max-w-2xl bg-[#2a231c] rounded-lg animate-pulse"></div>
        </div>
        ...
        <div className="grid gap-3 sm:gap-4 grid-cols-2 md:grid-cols-2 lg:grid-cols-3 mb-10">
          {[...Array(3)].map((_, i) => (
            <div
              key={i}
              className="rounded-lg sm:rounded-[24px] border border-[#221b14] bg-[#0a0c0e] p-4 sm:p-5"
            >
              <div className="h-3 w-16 bg-[#2a231c] rounded animate-pulse mb-2"></div>
              <div className="h-6 w-24 bg-[#2a231c] rounded animate-pulse"></div>
            </div>
          ))}
        </div>
        ...
        <div className="space-y-6">
          {/* Title */}
          <div className="h-6 w-48 bg-[#2a231c] rounded-lg animate-pulse"></div>
          ...
          <div className="grid gap-3 sm:gap-4 md:gap-6 grid-cols-2 md:grid-cols-2 lg:grid-cols-3">
            {[...Array(6)].map((_, i) => (
              <div
                key={i}
                className="rounded-lg sm:rounded-2xl border border-[#1d1711] bg-[#090b0c]"
              >
                {/* Image */}
